...
public:
	...
	ofColor colors[10] = { ofColor::white, ofColor::red, ofColor::orange, ofColor::yellow, ofColor::green,
						   ofColor::blue, ofColor::indigo, ofColor::violet, ofColor::pink, ofColor::brown };
